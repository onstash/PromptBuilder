...
/**
 * V2 Context Step with role-aware suggestions
 *
 * Step 3: Give context (Context + Examples)
 * Shows role-specific context suggestions based on the ai_role field.
 */
export function ContextStepV2({ data, onUpdate }: StepProps) {

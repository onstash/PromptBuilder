...
import {
  ...
  type PromptBuilderBasicFormDataShortened,
...
export function PromptBuilderBasic() {
  // Type-safe: explicitly type the search params from our schema
  const searchParams = useSearch({
    strict: false,
  }) as PromptBuilderBasicFormDataShortened;
                        ...
                        <form.Field name="context_understanding">
                          {(field) => (
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-muted-foreground">
                                How the AI understands the meaning of your
                                message in general.
                              </p>
                              <Textarea
                        ...
                        <form.Field name="ui_ux_best_practices">
                          {(field) => (
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Good design rules to keep apps clear, usable,
                                and responsive.
                              </p>
                              <Textarea

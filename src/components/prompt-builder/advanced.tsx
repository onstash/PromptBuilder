...
export const promptBuilderAdvanedFormSchema = z
  .object({
    task_intent: z.string().min(5, "Describe what you want."),
    target_audience: z.string().optional(),
    context_gathering: z.string().optional(),
    examples_optional: z.string().optional(),
    ...
    reasoning_depth: z.enum([
      "quick",
      "medium",
      "deep",
      "expert_chain_of_thought",
    ]),
...
export type PromptBuilderFormData = z.infer<
  typeof promptBuilderAdvanedFormSchema
>;
...
export function PromptBuilderAdvanced() {
  ...
  const form = useForm({
    ...
    validators: {
      onChange: promptBuilderAdvanedFormSchema,
      onBlurAsync: (opts) => {
        console.log("[onBlurAsync]", opts);
      },
    },
                ...
                <AccordionItem value="optional-fields">
                  ...
                  >
                    <AccordionContent className="space-y-6 px-4 py-4">
                      ...
                      <form.Field name="context_gathering">
                        {(field) => (
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                              What background information should the AI
                              consider?
                            </p>
                            <Textarea
                      ...
                      {/* Examples */}
                      <form.Field name="examples_optional">
                        {(field) => (
                          <div className="space-y-2">
                            <Label
                              htmlFor="examples_optional"
                              className="text-sm font-semibold"
                            >
                              Examples
                            </Label>
                      ...
                      {/* Factuality Rules */}
                      <form.Field name="factuality_rules">
                        {(field) => (
                          <div className="space-y-2">
                            <Label
                      ...
                      {/* Disallowed Content */}
                      <form.Field name="disallowed_content">
                        {(field) => (
                          <div className="space-y-2">
                            <Label
